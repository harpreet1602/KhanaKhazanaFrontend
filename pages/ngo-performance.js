...
const NgoPerformance = () => {
    ...
    const getDetails = () => {
        ...
        const requestOptions = {
            ...
            body: JSON.stringify({ ngoId: localStorage.getItem("ngoId") })
        };
    ...
    useEffect(() => {
        setNgoId(JSON.stringify(localStorage.getItem('ngoId')));
        ...
        <>
            <div className='bg-your-donation pb-10'>
                <div className="flex justify-between items-center py-1 px-8 bg-[#09cc7f] text-white">
                    ...
                    <button className="ml-3 mt-2" onClick={() => router.push('/public-dashboard')}>
                        Back to Dashboard
                    </button>
